...
open class ItemSpadeFood(
	...
	@Suppress("unused")
	fun setPotionEffect(effect: PotionEffect, probability: Float): ItemSpadeFood {
	 ...
	 */
	fun setAlwaysEdible(): ItemSpadeFood {
